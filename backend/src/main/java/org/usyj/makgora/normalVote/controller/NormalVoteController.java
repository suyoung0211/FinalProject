package org.usyj.makgora.normalVote.controller;
...
import org.usyj.makgora.normalVote.dto.request.NormalVoteParticipateRequest;
import org.usyj.makgora.normalVote.dto.response.*;
import org.usyj.makgora.normalVote.service.NormalVoteDetailService;
import org.usyj.makgora.normalVote.service.NormalVoteService;
...
public ResponseEntity<?> getNormalVoteDetail(
    ...
    public ResponseEntity<NormalVoteResponse> update(
            ...
            @RequestBody NormalVoteChoiceUpdateRequest req,
            @AuthenticationPrincipal CustomUserDetails user
    ) {
