...
//     private final CommunityPostReactionService reactionService; // 추가!!
...
//      * - 비추천 -0.5
//      * - 댓글수 2.0
//      * - 댓글 좋아요 합 1.0 (Redis 기반)
//      */
//     public int calculateScore(CommunityPostEntity post) {

//         long commentLikes = reactionService.getTotalCommentLikes(post.getPostId()); // Redis!!!
